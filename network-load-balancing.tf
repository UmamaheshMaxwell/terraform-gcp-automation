...
#     }
#   }
#   metadata_startup_script = templatefile("./network-load-balancing.sh", {foldername = "blue"})
# }
...
#   metadata_startup_script = templatefile("./network-load-balancing.sh", {foldername = "green"})
# }
